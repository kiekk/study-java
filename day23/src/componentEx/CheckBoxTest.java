...
/*
 	CheckBox - 다중 선택
		...
		CheckBoxGroup을 이용하면, 라디오버튼(여러개중에 하나만 선택)
									기능 구현 할 수 있습니다.
 */
public class CheckBoxTest {
	public static ItemListener click = new ItemListener() {
		...
		public void itemStateChanged(ItemEvent e) {
			System.out.println("한달에 "+e.getItem()+"봅니다.");
		}
	}; 
	public static void main(String[] args) {
		...
		news.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				String msg = e.getStateChange()==1?"체크했음:뉴스선택":"뉴스선택안함";
		...
		f.add(question);
		f.add(news);
		//라디오 버튼 : 다중 택일합니다. 체크박스들을 모아서 그룹에 넣으면 여러개중 하나만 선택하는 라디오버튼 기능을 구현할 수 있습니다.
